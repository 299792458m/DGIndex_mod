...
@SSE2MMX_IDCT@4 proc near
    ...
    DCT_8_INV_ROW_1_s2 [eax+0], [eax+0], tab_i_04_s2, rounder_2_0
    DCT_8_INV_ROW_1_s2 [eax+16], [eax+16], tab_i_17_s2, rounder_2_1
    DCT_8_INV_ROW_1_s2 [eax+32], [eax+32], tab_i_26_s2, rounder_2_2
    DCT_8_INV_ROW_1_s2 [eax+48], [eax+48], tab_i_35_s2, rounder_2_3
    DCT_8_INV_ROW_1_s2 [eax+64], [eax+64], tab_i_04_s2, rounder_2_4
    DCT_8_INV_ROW_1_s2 [eax+80], [eax+80], tab_i_35_s2, rounder_2_5
    DCT_8_INV_ROW_1_s2 [eax+96], [eax+96], tab_i_26_s2, rounder_2_6
    DCT_8_INV_ROW_1_s2 [eax+112], [eax+112], tab_i_17_s2, rounder_2_7

    DCT_8_INV_COL_4_s2 [eax+0],[eax+0]
